...
export const createSampleData = (): { tasks: Task[], projects: Project[], categories: Category[] } => {
  ...
  const oneWeekAgo = formatDate(new Date(Date.now() - 7 * 86400000));
  ...
  const tasks: Task[] = [
    ...
    // Overdue tasks for accountability check-in demo
    {
      id: generateId(),
      title: 'Submit expense reports',
      description: 'Submit monthly expense reports to accounting',
      completed: false,
    ...
    },
    {
      ...
      description: 'Schedule routine dental cleaning',
      completed: false,
      dueDate: oneWeekAgo,
      projectId: null,
      categoryIds: [categories[1].id],
    ...
    },
    {
      ...
      description: 'Add recent work achievements and skills',
      completed: false,
      dueDate: yesterday,
      projectId: null,
      categoryIds: [categories[0].id],
